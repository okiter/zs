...
<div class="wrapper">
	...
	<div class="main">
		<!--tab-->
		<ul class="headTab">
			<li class="on"><a href="#">活动列表</a></li>
			<li><a href="add.html">添加活动</a></li>
		</ul>
		...
		<div class="tableBox">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
				<tr>
					...
					<th scope="col" style="width:400px;">活动标题</th>
					<th scope="col" style="width:200px;">栏目推荐</th>
				...
				<tr>
					...
					<td class="center"><span class="tagBox4">否</span></td>
				...
				<tr>
					...
					<td class="left">马太太的花园</td>
					<td class="center"><span class="tagBox1">是</span></td>
					<td class="center">2014-10-15 11:20:50</td>
					<td class="center">
						<a href="#">删除</a>
						<span style="padding-right:1em;"></span>
